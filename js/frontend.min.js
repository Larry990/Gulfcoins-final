...
function updateCircles() {
  const sliderValue = parseInt(document.querySelector('input[type="range"]').value);

  const circle1 = document.getElementById('circle1');
  const circle2 = document.getElementById('circle2');
  const circle3 = document.getElementById('circle3');

  const circleText1 = document.getElementById('circleText1');
  const circleText2 = document.getElementById('circleText2');
  const circleText3 = document.getElementById('circleText3');	
	
  const sliderHintElement = document.getElementById('sliderHint');
  const sliderTextElement = document.getElementById('sliderText'); // New element for slider text

  circle1.textContent = `${sliderValue * 1/8}%`;
  circle2.textContent = `${sliderValue * 1/4}%`;
  circle3.textContent = `${sliderValue * 1/2}%`;

  sliderHintElement.textContent = `$${sliderValue}`;
  sliderHintElement.style.display = 'block'; // Show slider hint

  sliderTextElement.textContent = `Invest`; // Set text for the slider
